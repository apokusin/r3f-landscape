...
const vec3 FOG_BASE_COLOR   = vec3(0.1, 0.1, 0.1);
const vec3 FOG_SUN_COLOR    = vec3(0.10, 0.60, 0.45);

// Scatter color tints near horizon
const vec3 SCATTER_COLOR1   = vec3(0.10, 0.10, 0.10);
const vec3 SCATTER_COLOR2   = vec3(0.10, 0.10, 0.10);
const vec3 SCATTER_COLOR3   = vec3(0.10, 0.10, 0.10);
